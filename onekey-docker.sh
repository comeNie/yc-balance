...
docker build -t 10.19.13.18:5000/yc-balance:${tagversion} .
docker push 10.19.13.18:5000/yc-balance:${tagversion}

docker rmi aioptapp/yc-balance:${tagversion}
docker tag 10.19.13.18:5000/yc-balance:${tagversion} aioptapp/yc-balance:${tagversion}
