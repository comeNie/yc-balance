...
2.生成镜像
#在本地生成带私服前缀的镜像
docker build -t 10.19.13.18:5000/yc-balance:v1.0 .   (每次打镜像前版本号要更新)
#将镜像推送到私服
docker push 10.19.13.18:5000/yc-balance:v1.0
...
-e "PAAS_CCS_ID=CCS005" \
-e "PAAS_CCS_PWD=123456" \
-e "SRVAREA_ALL=cn.hb,us.ea"  \
-e "SRVAREA_CURR=cn.hb"  \
10.19.13.18:5000/yc-balance:v1.0_2
#查看镜像启动日志
docker logs yc-balance
#进入容器，查看镜像内部的情况
docker exec -it yc-balance /bin/bash
#删除运行的容器
docker rm -fv yc-balance
